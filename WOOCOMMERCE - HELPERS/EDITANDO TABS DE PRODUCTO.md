...
* Sólo se mostrará si el producto tiene ancho, alto, atributos, aso contrario mostrará un error, para evitar este error usaremos funciones dentro de una condicional.
